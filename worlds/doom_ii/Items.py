...
item_name_groups: Dict[str, Set[str]] = {
    ...
    'MAP01': {'Entryway (MAP01)', },
    'MAP01 Map': {'Entryway (MAP01) - Computer area map', },
    'MAP02': {'Underhalls (MAP02)', },
    'MAP02 Blue': {'Underhalls (MAP02) - Blue keycard', },
    'MAP02 Keys': {'Underhalls (MAP02) - Blue keycard', 'Underhalls (MAP02) - Red keycard', },
    'MAP02 Map': {'Underhalls (MAP02) - Computer area map', },
    'MAP02 Red': {'Underhalls (MAP02) - Red keycard', },
    'MAP03': {'The Gantlet (MAP03)', },
    'MAP03 Blue': {'The Gantlet (MAP03) - Blue keycard', },
    'MAP03 Keys': {'The Gantlet (MAP03) - Blue keycard', 'The Gantlet (MAP03) - Red keycard', },
    'MAP03 Map': {'The Gantlet (MAP03) - Computer area map', },
    'MAP03 Red': {'The Gantlet (MAP03) - Red keycard', },
    'MAP04': {'The Focus (MAP04)', },
    'MAP04 Blue': {'The Focus (MAP04) - Blue keycard', },
    'MAP04 Keys': {'The Focus (MAP04) - Blue keycard', 'The Focus (MAP04) - Red keycard', 'The Focus (MAP04) - Yellow keycard', },
    'MAP04 Map': {'The Focus (MAP04) - Computer area map', },
    'MAP04 Red': {'The Focus (MAP04) - Red keycard', },
    'MAP04 Yellow': {'The Focus (MAP04) - Yellow keycard', },
    'MAP05': {'The Waste Tunnels (MAP05)', },
    'MAP05 Blue': {'The Waste Tunnels (MAP05) - Blue keycard', },
    'MAP05 Keys': {'The Waste Tunnels (MAP05) - Blue keycard', 'The Waste Tunnels (MAP05) - Red keycard', 'The Waste Tunnels (MAP05) - Yellow keycard', },
    'MAP05 Map': {'The Waste Tunnels (MAP05) - Computer area map', },
    'MAP05 Red': {'The Waste Tunnels (MAP05) - Red keycard', },
    'MAP05 Yellow': {'The Waste Tunnels (MAP05) - Yellow keycard', },
    'MAP06': {'The Crusher (MAP06)', },
    'MAP06 Blue': {'The Crusher (MAP06) - Blue keycard', },
    'MAP06 Keys': {'The Crusher (MAP06) - Blue keycard', 'The Crusher (MAP06) - Red keycard', 'The Crusher (MAP06) - Yellow keycard', },
    'MAP06 Map': {'The Crusher (MAP06) - Computer area map', },
    'MAP06 Red': {'The Crusher (MAP06) - Red keycard', },
    'MAP06 Yellow': {'The Crusher (MAP06) - Yellow keycard', },
    'MAP07': {'Dead Simple (MAP07)', },
    'MAP07 Map': {'Dead Simple (MAP07) - Computer area map', },
    'MAP08': {'Tricks and Traps (MAP08)', },
    'MAP08 Keys': {'Tricks and Traps (MAP08) - Red skull key', 'Tricks and Traps (MAP08) - Yellow skull key', },
    'MAP08 Map': {'Tricks and Traps (MAP08) - Computer area map', },
    'MAP08 Red': {'Tricks and Traps (MAP08) - Red skull key', },
    'MAP08 Yellow': {'Tricks and Traps (MAP08) - Yellow skull key', },
    'MAP09': {'The Pit (MAP09)', },
    'MAP09 Blue': {'The Pit (MAP09) - Blue keycard', },
    'MAP09 Keys': {'The Pit (MAP09) - Blue keycard', 'The Pit (MAP09) - Yellow keycard', },
    'MAP09 Map': {'The Pit (MAP09) - Computer area map', },
    'MAP09 Yellow': {'The Pit (MAP09) - Yellow keycard', },
    'MAP10': {'Refueling Base (MAP10)', },
    'MAP10 Blue': {'Refueling Base (MAP10) - Blue keycard', },
    'MAP10 Keys': {'Refueling Base (MAP10) - Blue keycard', 'Refueling Base (MAP10) - Yellow keycard', },
    'MAP10 Map': {'Refueling Base (MAP10) - Computer area map', },
    'MAP10 Yellow': {'Refueling Base (MAP10) - Yellow keycard', },
    'MAP11': {'Circle of Death (MAP11)', },
    'MAP11 Blue': {'Circle of Death (MAP11) - Blue keycard', },
    'MAP11 Keys': {'Circle of Death (MAP11) - Blue keycard', 'Circle of Death (MAP11) - Red keycard', },
    'MAP11 Map': {'Circle of Death (MAP11) - Computer area map', },
    'MAP11 Red': {'Circle of Death (MAP11) - Red keycard', },
    'MAP12': {'The Factory (MAP12)', },
    'MAP12 Blue': {'The Factory (MAP12) - Blue keycard', },
    'MAP12 Keys': {'The Factory (MAP12) - Blue keycard', 'The Factory (MAP12) - Yellow keycard', },
    'MAP12 Map': {'The Factory (MAP12) - Computer area map', },
    'MAP12 Yellow': {'The Factory (MAP12) - Yellow keycard', },
    'MAP13': {'Downtown (MAP13)', },
    'MAP13 Blue': {'Downtown (MAP13) - Blue keycard', },
    'MAP13 Keys': {'Downtown (MAP13) - Blue keycard', 'Downtown (MAP13) - Red keycard', 'Downtown (MAP13) - Yellow keycard', },
    'MAP13 Map': {'Downtown (MAP13) - Computer area map', },
    'MAP13 Red': {'Downtown (MAP13) - Red keycard', },
    'MAP13 Yellow': {'Downtown (MAP13) - Yellow keycard', },
    'MAP14': {'The Inmost Dens (MAP14)', },
    'MAP14 Blue': {'The Inmost Dens (MAP14) - Blue skull key', },
    'MAP14 Keys': {'The Inmost Dens (MAP14) - Blue skull key', 'The Inmost Dens (MAP14) - Red skull key', },
    'MAP14 Map': {'The Inmost Dens (MAP14) - Computer area map', },
    'MAP14 Red': {'The Inmost Dens (MAP14) - Red skull key', },
    'MAP15': {'Industrial Zone (MAP15)', },
    'MAP15 Blue': {'Industrial Zone (MAP15) - Blue keycard', },
    'MAP15 Keys': {'Industrial Zone (MAP15) - Blue keycard', 'Industrial Zone (MAP15) - Red keycard', 'Industrial Zone (MAP15) - Yellow keycard', },
    'MAP15 Map': {'Industrial Zone (MAP15) - Computer area map', },
    'MAP15 Red': {'Industrial Zone (MAP15) - Red keycard', },
    'MAP15 Yellow': {'Industrial Zone (MAP15) - Yellow keycard', },
    'MAP16': {'Suburbs (MAP16)', },
    'MAP16 Blue': {'Suburbs (MAP16) - Blue skull key', },
    'MAP16 Keys': {'Suburbs (MAP16) - Blue skull key', 'Suburbs (MAP16) - Red skull key', },
    'MAP16 Map': {'Suburbs (MAP16) - Computer area map', },
    'MAP16 Red': {'Suburbs (MAP16) - Red skull key', },
    'MAP17': {'Tenements (MAP17)', },
    'MAP17 Blue': {'Tenements (MAP17) - Blue keycard', },
    'MAP17 Keys': {'Tenements (MAP17) - Blue keycard', 'Tenements (MAP17) - Red keycard', 'Tenements (MAP17) - Yellow skull key', },
    'MAP17 Map': {'Tenements (MAP17) - Computer area map', },
    'MAP17 Red': {'Tenements (MAP17) - Red keycard', },
    'MAP17 Yellow': {'Tenements (MAP17) - Yellow skull key', },
    'MAP18': {'The Courtyard (MAP18)', },
    'MAP18 Blue': {'The Courtyard (MAP18) - Blue skull key', },
    'MAP18 Keys': {'The Courtyard (MAP18) - Blue skull key', 'The Courtyard (MAP18) - Yellow skull key', },
    'MAP18 Map': {'The Courtyard (MAP18) - Computer area map', },
    'MAP18 Yellow': {'The Courtyard (MAP18) - Yellow skull key', },
    'MAP19': {'The Citadel (MAP19)', },
    'MAP19 Blue': {'The Citadel (MAP19) - Blue skull key', },
    'MAP19 Keys': {'The Citadel (MAP19) - Blue skull key', 'The Citadel (MAP19) - Red skull key', 'The Citadel (MAP19) - Yellow skull key', },
    'MAP19 Map': {'The Citadel (MAP19) - Computer area map', },
    'MAP19 Red': {'The Citadel (MAP19) - Red skull key', },
    'MAP19 Yellow': {'The Citadel (MAP19) - Yellow skull key', },
    'MAP20': {'Gotcha! (MAP20)', },
    'MAP20 Map': {'Gotcha! (MAP20) - Computer area map', },
    'MAP21': {'Nirvana (MAP21)', },
    'MAP21 Blue': {'Nirvana (MAP21) - Blue skull key', },
    'MAP21 Keys': {'Nirvana (MAP21) - Blue skull key', 'Nirvana (MAP21) - Red skull key', 'Nirvana (MAP21) - Yellow skull key', },
    'MAP21 Map': {'Nirvana (MAP21) - Computer area map', },
    'MAP21 Red': {'Nirvana (MAP21) - Red skull key', },
    'MAP21 Yellow': {'Nirvana (MAP21) - Yellow skull key', },
    'MAP22': {'The Catacombs (MAP22)', },
    'MAP22 Blue': {'The Catacombs (MAP22) - Blue skull key', },
    'MAP22 Keys': {'The Catacombs (MAP22) - Blue skull key', 'The Catacombs (MAP22) - Red skull key', },
    'MAP22 Map': {'The Catacombs (MAP22) - Computer area map', },
    'MAP22 Red': {'The Catacombs (MAP22) - Red skull key', },
    'MAP23': {"Barrels o' Fun (MAP23)", },
    'MAP23 Keys': {"Barrels o' Fun (MAP23) - Yellow skull key", },
    'MAP23 Map': {"Barrels o' Fun (MAP23) - Computer area map", },
    'MAP23 Yellow': {"Barrels o' Fun (MAP23) - Yellow skull key", },
    'MAP24': {'The Chasm (MAP24)', },
    'MAP24 Blue': {'The Chasm (MAP24) - Blue keycard', },
    'MAP24 Keys': {'The Chasm (MAP24) - Blue keycard', 'The Chasm (MAP24) - Red keycard', },
    'MAP24 Map': {'The Chasm (MAP24) - Computer area map', },
    'MAP24 Red': {'The Chasm (MAP24) - Red keycard', },
    'MAP25': {'Bloodfalls (MAP25)', },
    'MAP25 Blue': {'Bloodfalls (MAP25) - Blue skull key', },
    'MAP25 Keys': {'Bloodfalls (MAP25) - Blue skull key', },
    'MAP25 Map': {'Bloodfalls (MAP25) - Computer area map', },
    'MAP26': {'The Abandoned Mines (MAP26)', },
    'MAP26 Blue': {'The Abandoned Mines (MAP26) - Blue keycard', },
    'MAP26 Keys': {'The Abandoned Mines (MAP26) - Blue keycard', 'The Abandoned Mines (MAP26) - Red keycard', 'The Abandoned Mines (MAP26) - Yellow keycard', },
    'MAP26 Map': {'The Abandoned Mines (MAP26) - Computer area map', },
    'MAP26 Red': {'The Abandoned Mines (MAP26) - Red keycard', },
    'MAP26 Yellow': {'The Abandoned Mines (MAP26) - Yellow keycard', },
    'MAP27': {'Monster Condo (MAP27)', },
    'MAP27 Blue': {'Monster Condo (MAP27) - Blue skull key', },
    'MAP27 Keys': {'Monster Condo (MAP27) - Blue skull key', 'Monster Condo (MAP27) - Red skull key', 'Monster Condo (MAP27) - Yellow skull key', },
    'MAP27 Map': {'Monster Condo (MAP27) - Computer area map', },
    'MAP27 Red': {'Monster Condo (MAP27) - Red skull key', },
    'MAP27 Yellow': {'Monster Condo (MAP27) - Yellow skull key', },
    'MAP28': {'The Spirit World (MAP28)', },
    'MAP28 Keys': {'The Spirit World (MAP28) - Red skull key', 'The Spirit World (MAP28) - Yellow skull key', },
    'MAP28 Map': {'The Spirit World (MAP28) - Computer area map', },
    'MAP28 Red': {'The Spirit World (MAP28) - Red skull key', },
    'MAP28 Yellow': {'The Spirit World (MAP28) - Yellow skull key', },
    'MAP29': {'The Living End (MAP29)', },
    'MAP29 Map': {'The Living End (MAP29) - Computer area map', },
    'MAP30': {'Icon of Sin (MAP30)', },
    'MAP30 Map': {'Icon of Sin (MAP30) - Computer area map', },
    'MAP31': {'Wolfenstein (MAP31)', },
    'MAP31 Map': {'Wolfenstein (MAP31) - Computer area map', },
    'MAP32': {'Grosse (MAP32)', },
    'MAP32 Map': {'Grosse (MAP32) - Computer area map', },
