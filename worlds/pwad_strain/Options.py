...
class RandomMonsters(Choice):
    ...
    This option is currently untested for PWADs, and likely will cause problems. Use it at your own risk.
    """
...
class MaxAmmoBatteries(Range):
    """Set the starting ammo capacity for batteries."""
    display_name = "Max Ammo - Batteries"
    visibility = Visibility.all ^ Visibility.spoiler
    range_start = 50
    range_end = 999
    default = 50
...
class AddedAmmoBatteries(Range):
    """Set the amount of battery capacity added when collecting a backpack or capacity upgrade."""
    display_name = "Added Ammo - Batteries"
    visibility = Visibility.all ^ Visibility.spoiler
    range_start = 5
    range_end = 999
    default = 50
...
@dataclass
class DOOM2STRAINOptions(PerGameCommonOptions):
